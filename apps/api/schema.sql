...
CREATE TYPE "public"."interview_status" AS ENUM ('IN_PROGRESS', 'DONE', 'ABORTED');

ALTER TYPE "public"."interview_status" OWNER TO "postgres";

CREATE
OR REPLACE FUNCTION "public"."get_items_by_collection"("pcollection_id" "uuid") RETURNS TABLE(
  "id" "uuid",
  "name" "text",
  "type" "text",
  "parent_item_id" "uuid",
  "collection_id" "uuid"
) LANGUAGE "plpgsql" AS $ _ $ BEGIN RETURN QUERY WITH RECURSIVE item_hierarchy AS (
  SELECT
    id,
    name,
    type,
...
CREATE
OR REPLACE FUNCTION "public"."update_collection_updated_at"() RETURNS "trigger" LANGUAGE "plpgsql" AS $ $ begin new.updated_at = now();
...
CREATE
OR REPLACE FUNCTION "public"."update_messages_updated_at"() RETURNS "trigger" LANGUAGE "plpgsql" AS $ $ begin new.updated_at = now();
...
CREATE
OR REPLACE FUNCTION "public"."update_updated_at"() RETURNS "trigger" LANGUAGE "plpgsql" AS $ $ begin new.updated_at = now();
...
ALTER TABLE
  "public"."interview_answers" OWNER TO "postgres";
...
ALTER TABLE
  "public"."interview_turns" OWNER TO "postgres";
...
ALTER TABLE
  "public"."interviews" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."items" (
  ...
  CONSTRAINT "chk_item_parent_or_collection" CHECK (
    (
      (
        ("collection_id" IS NOT NULL)
        AND ("parent_item_id" IS NULL)
        AND ("type" = 'folder' :: "text")
      )
      OR (
  ...
  CONSTRAINT "chk_item_type" CHECK (
    (
      "type" = ANY (
        ARRAY ['folder'::"text", 'request'::"text", 'interview'::"text"]
      )
    )
  )
);
...
ALTER TABLE
  "public"."user_collections" OWNER TO "postgres";
...
ALTER TABLE
  ONLY "public"."interview_answers"
ADD
  CONSTRAINT "interview_answers_turn_id_version_key" UNIQUE ("turn_id", "version");

ALTER TABLE
  ONLY "public"."interview_turns"
ADD
  CONSTRAINT "interview_turns_interview_id_turn_no_key" UNIQUE ("interview_id", "turn_no");
...
CREATE UNIQUE INDEX "ix_answers_latest" ON "public"."interview_answers" USING "btree" ("turn_id")
WHERE
  ("version" = 1);
...
CREATE
OR REPLACE TRIGGER "trg_interview_answers_updated_at" BEFORE
UPDATE
  ON "public"."interview_answers" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();

CREATE
OR REPLACE TRIGGER "trg_interview_turns_updated_at" BEFORE
UPDATE
  ON "public"."interview_turns" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();

CREATE
OR REPLACE TRIGGER "trg_interviews_updated_at" BEFORE
UPDATE
  ON "public"."interviews" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();

CREATE
OR REPLACE TRIGGER "update_chat_updated_at" BEFORE
UPDATE
  ON "public"."chats" FOR EACH ROW EXECUTE FUNCTION "public"."update_chat_updated_at"();

CREATE
OR REPLACE TRIGGER "update_collection_updated_at" BEFORE
UPDATE
  ON "public"."user_collections" FOR EACH ROW EXECUTE FUNCTION "public"."update_collection_updated_at"();
...
ALTER TABLE
  ONLY "public"."chats"
ADD
  CONSTRAINT "fk_chat_user" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE
  ONLY "public"."items"
ADD
  CONSTRAINT "fk_directory_collection" FOREIGN KEY ("collection_id") REFERENCES "public"."user_collections"("id") ON DELETE CASCADE;

ALTER TABLE
  ONLY "public"."items"
ADD
  CONSTRAINT "fk_directory_parent" FOREIGN KEY ("parent_item_id") REFERENCES "public"."items"("id") ON DELETE CASCADE;
...
ALTER TABLE
  ONLY "public"."pages"
ADD
  CONSTRAINT "fk_page_collection" FOREIGN KEY ("collection_id") REFERENCES "public"."user_collections"("id") ON DELETE CASCADE;

ALTER TABLE
  ONLY "public"."pages"
ADD
  CONSTRAINT "fk_page_item" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id") ON DELETE CASCADE;

ALTER TABLE
  ONLY "public"."interview_answers"
ADD
  CONSTRAINT "interview_answers_turn_id_fkey" FOREIGN KEY ("turn_id") REFERENCES "public"."interview_turns"("id") ON DELETE CASCADE;

ALTER TABLE
  ONLY "public"."interview_turns"
ADD
  CONSTRAINT "interview_turns_interview_id_fkey" FOREIGN KEY ("interview_id") REFERENCES "public"."interviews"("id") ON DELETE CASCADE;

ALTER TABLE
  ONLY "public"."interviews"
ADD
  CONSTRAINT "interviews_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id") ON DELETE CASCADE;

ALTER TABLE
  ONLY "public"."interviews"
ADD
  CONSTRAINT "interviews_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;

CREATE POLICY "allow delete for chat owners" ON "public"."chats" FOR DELETE USING (("auth"."uid"() = "user_id"));

CREATE POLICY "allow delete for chat owners" ON "public"."messages" FOR DELETE USING (
  (
    EXISTS (
      SELECT
        1
...
CREATE POLICY "allow delete for page owners" ON "public"."pages" FOR DELETE USING (
  (
    EXISTS (
      SELECT
        1
      ...
      WHERE
        (
          (
            "user_collections"."id" = "pages"."collection_id"
          )
          AND ("user_collections"."user_id" = "auth"."uid"())
        )
    )
...
CREATE POLICY "allow insert for authenticated users" ON "public"."chats" FOR
INSERT
  WITH CHECK (("auth"."uid"() = "user_id"));

CREATE POLICY "allow insert for chat owners" ON "public"."messages" FOR
INSERT
  WITH CHECK (
    (
      EXISTS (
      ...
      OR (
        EXISTS (
          ...
          FROM
            (
              "public"."items" "parent"
              JOIN "public"."user_collections" ON (
                (
                  "parent"."collection_id" = "user_collections"."id"
                )
              )
            )
          WHERE
            (
              ("parent"."id" = "items"."parent_item_id")
              AND ("user_collections"."user_id" = "auth"."uid"())
            )
        )
      )
...
CREATE POLICY "allow insert for page owners" ON "public"."pages" FOR
INSERT
  WITH CHECK (
    (
      (
        ...
        EXISTS (
          ...
          FROM
            (
              ...
              JOIN "public"."user_collections" ON (
                (
                  "items"."collection_id" = "user_collections"."id"
                )
              )
            )
          WHERE
            (
              ("items"."id" = "pages"."item_id")
              AND ("user_collections"."user_id" = "auth"."uid"())
            )
        )
      )
...
CREATE POLICY "allow insert for user_collections owners" ON "public"."user_collections" FOR
INSERT
  WITH CHECK (("auth"."uid"() = "user_id"));

CREATE POLICY "allow read access for chat owners" ON "public"."chats" FOR
SELECT
  USING (("auth"."uid"() = "user_id"));

CREATE POLICY "allow read access for chat owners" ON "public"."messages" FOR
SELECT
...
CREATE POLICY "allow read access for page owners" ON "public"."pages" FOR
SELECT
  TO "authenticated" USING (
    (
      (
...
CREATE POLICY "allow read access for user_collections owners" ON "public"."user_collections" FOR
SELECT
  TO "authenticated" USING (("auth"."uid"() = "user_id"));

CREATE POLICY "allow update for chat owners" ON "public"."chats" FOR
UPDATE
  USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "allow update for message owners" ON "public"."messages" FOR
UPDATE
  USING (
    (
      EXISTS (
...
CREATE POLICY "allow update for page owners" ON "public"."pages" FOR
UPDATE
  USING (
    (
      EXISTS (
...
CREATE POLICY "allow update for user_collections owners" ON "public"."user_collections" FOR
UPDATE
  USING (("auth"."uid"() = "user_id"));
...
ALTER TABLE
  "public"."items" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE
  "public"."user_collections" ENABLE ROW LEVEL SECURITY;
